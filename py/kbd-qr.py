...
DEV = '/dev/input/by-id/usb-Newtologic_7733XP_XXXXXX-event-kbd'

HTTP_HOST = '10.110.71.231' #'10.130.1.23'
HTTP_PORT = 2003 #7730
HTTP_PATH = '/qr'
...
def send_buffer(data):
    ...
    try:
        ...
        # при необходимости можно добавить retry
        pass
